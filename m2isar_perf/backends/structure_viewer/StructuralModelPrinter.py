...
class StructuralModelPrinter:
    ...
    def __createMicroactions(self):
        ...
        for uA in self.corePerfModel.getAllMicroactions():
            ...
            renderDict = {"printHelper_": self.printHelper,
                          "microaction": uA}
    ...
    def __makePdf(self, name_, usedMicroactions_):
        ...
        renderDict = {"printHelper_": self.printHelper,
                      "microactionList": self.corePerfModel.getAllMicroactions(),
